...
## Headless
I had to modify my code from i2c to display the data graphically for one variable on the OLED screen. I decided to do a line graph to depict the data. I had to add a few aspects to the code like defining a map range to create a graph for the dataa and an if?else statement to     and a for loop to 
